...
import lab4.problems.CircularDoublyLinkedList;

public class CircularDoublyLinkedListTest {
	
	CircularDoublyLinkedList<String> l;
	...
	private boolean equals(CircularDoublyLinkedList<String> l, String[] expected) {
