...
/**Consider a non-member static method called totalCount(). This method receives two parameters: 
A string s 
An array of lists, each of type List<String>.
The method totalCount() finds the total number of copies of string s in all the lists in the array. Implement the method totalCount().
 */
import java.util.Iterator;
import java.util.NoSuchElementException;

public class Lab04CountWrapper {
